...
namespace Schronisko.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            //Imię//
            [Required]
            [StringLength(255, ErrorMessage = "Imię nie może zawierać więcej niż 255 znaków")]
            [Display(Name ="Imię")]
            public string FirstName { get; set; }

            //Nazwisko//
            [Required]
            [StringLength(255, ErrorMessage = "Nazwisko nie może zawierać więcej niż 255 znaków")]
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "Wprowadź inne hasło.", MinimumLength = 6)]
